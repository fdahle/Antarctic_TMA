...
def resample_tie_points(points, trans_mat):
    ...
    points_tr[:,0] = trans_mat[0][0] * points_np[:,0] + trans_mat[0][1] * points_np[:,1] + trans_mat[0][2]
    points_tr[:,1] = trans_mat[1][0] * points_np[:,0] + trans_mat[1][1] * points_np[:,1] + trans_mat[1][2]
