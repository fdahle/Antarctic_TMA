...
# https://medium.com/analytics-vidhya/creating-a-very-simple-u-net-model-with-pytorch-for-
# semantic-segmentation-of-satellite-images-223aa216e705
...
class UNET(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3, 3)):
        ...
        self.conv4 = self.contract_block(128, 256, kernel_size, padding=1)
