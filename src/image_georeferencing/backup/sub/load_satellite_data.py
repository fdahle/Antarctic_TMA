    ...
    try:
        ...
        if len(mosaic_files) == 0:
            ...
            if fallback_month and month != 0:
                ...
                if return_transform:
                    cr, cr_tr = load_satellite_data(bounds, satellite_type, 0, False,
                                                    satellite_path, satellite_crs,
                                                    True, catch, verbose, pbar)
                    return cr, cr_tr
                else:
                    cr = load_satellite_data(bounds, satellite_type, 0, False,
                                             satellite_path, satellite_crs,
                                             False, catch, verbose, pbar)
                    return cr
