...
def check_georef_validity(tiff_path, return_reason=False,
                          catch=True, verbose=False, pbar=None):
    """
    check_georef_validity(tiff_path, return_reason, catch, verbose, pbar):
...
if __name__ == "__main__":
    ...
    for _image_id in _ids:
        if os.path.isfile(_tiff_path + _image_id + ".tif") is False:
            ...
            continue
        status = check_georef_validity(_tiff_path + _image_id + ".tif", verbose=True)
