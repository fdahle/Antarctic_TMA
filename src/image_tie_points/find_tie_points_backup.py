...
debug_show_additional_tiles = False
    ...
    try:
        ...
        if additional_matching is True and (bool_resized_1 is True or bool_resized_2 is True):
            ...
            for y_counter in range(0, math.ceil(num_y)):
                for x_counter in range(0, math.ceil(num_x)):
                    ...
                    if debug_show_additional_subset:
                        ...
                        dt.display_tiepoints([[base_subset, other_subset], [base_subset, other_subset]],
                                             points=[temp_mkpts, mkpts_sub], confidences=[temp_conf, mconf_sub],
            ...
            if debug_show_additional_tiles:
                di.display_images([base_img, other_img], bboxes=[tiles, other_tiles])
            ...
            if debug_show_additional_tiepoints:
                dt.display_tiepoints([[input_img1, input_img2]], [additional_tiepoints], [additional_confidences],
