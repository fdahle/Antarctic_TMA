...
class UNET(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3, 3), use_drop=True, use_batch=True):
        ...
        self.conv3 = self.contract_block(64, 128, kernel_size, padding=1, use_drop=use_drop, use_batch=use_batch)
        self.conv4 = self.contract_block(128, 256, kernel_size, padding=1, use_drop=use_drop, use_batch=use_batch)

        self.upconv4 = self.expand_block(256, 128, kernel_size, 1, output_padding=1, use_drop=use_drop, use_batch=use_batch)
        self.upconv3 = self.expand_block(128 * 2, 64, kernel_size, 1, output_padding=1, use_drop=use_drop, use_batch=use_batch)
        self.upconv2 = self.expand_block(64 * 2, 32, kernel_size, 1, output_padding=1, use_drop=use_drop, use_batch=use_batch)
